...
namespace Functional.Net.Tests.Option
{
    ...
    public static class Option_ApplicativeLaws
    {
        ...
        [Property]
        static void HomomorphismHolds(int x)
           => Assert.Equal(
        ...
        [Property]
        static void InterchangeHolds(bool uIsSome, int y)
        {
            var u = uIsSome ? Some(minus10) : None;
        ...
        [Property]
        static void ApplicativeLawHolds(int a, int b)
        {
        ...
        [Property]
        static void ApplicativeLawHolds_WhenApplyIsDefinedInTermsOfBind(int a, int b)
        {
